...
export default function ExamForm() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      {/* Sidebar */}
      <aside className="w-64 bg-slate-900 flex flex-col p-6 gap-6 fixed h-full">
        <div className="mb-4">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Instrucoes para os alunos..."
                rows={3}
              ...
              {form.allow_penalty && (
                <div className="grid grid-cols-2 gap-6 p-6 bg-slate-50 rounded-3xl border border-slate-100">
                  <div className="space-y-2">
                    ...
                    <input
                      type="number"
                      className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-900 font-bold"
                      value={form.penalty_per_wrong}
                      onChange={e => setForm({...form, penalty_per_wrong: Number(e.target.value)})}
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      type="number"
                      className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-900 font-bold"
                      value={form.penalty_per_blank}
                      onChange={e => setForm({...form, penalty_per_blank: Number(e.target.value)})}
                      min={0} max={100} step={0.5}
                    />
                  </div>
                </div>
